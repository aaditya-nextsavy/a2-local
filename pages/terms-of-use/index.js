...
const TermsOfUse = ({ locationInfo, categoryInfo, contactDataInfo, populerTourInfo, metaDataInfo, termsDataInfo }) => {
    ...
    if (selectedLanguageCode === 'ar') {
        canonicalPageURL = '/ar/terms-of-use'
        schema = {
            "@context": "http://schema.org",
            "@type": "WebPage",
            "name": "Terms of Use",
            "description": metaDataInfo.meta_description,
            "url": "https://athaararabia.com/ar/terms-of-use",
        }
    } else {
        canonicalPageURL = '/terms-of-use'
            schema = {
                "@context": "http://schema.org",
                "@type": "WebPage",
                "name": "Terms of Use",
                "description": metaDataInfo.meta_description,
                "url": "https://athaararabia.com/terms-of-use",
            }
    }
    ...
    return (
        <div className='faqs-wrapper'>
            ...
            {fullScreenLoader ? <FullScreenLoader /> :
                <>
                    <SubPageHeader
                        TitleSub={i18n.t('common.termsOfUse')}
                        TitleMain={i18n.t('termsOfUse.headerTitle')}
