...
const SubPageHeaderBlogDetails = (props) => {
  ...
  return (
    <>
      <PageWrap className={`${props.addClassName} `} >
        <Header populerTourData={props.populerTourData} categoryData={props.categoryData} />
        <div className='page-header SubPageHeaderBlogDetails'>
          <div className="container">
            <div className="row">
              <div className="col-xl-9 col-lg-7 col-md-12 col-sm-12">
                <div className='SectionTitle'>
                  ...
                  <div className='d-flex align-items-center'>
                    {props.blogCategory ? <div className="card-tags d-flex align-items-center me-2"><p>{props.blogCategory} </p></div> : ""}
                    {" "}
                    <h6 className='mb-0 pt-1'>{props.date}</h6>
              ...
              <div className="col-xl-3 col-lg-5 col-md-12 col-sm-12 d-flex flex-column justify-content-center align-items-end">
...
export default SubPageHeaderBlogDetails