...
import DestinationImg1 from '../../assets/images/destination (1).png'
import DestinationImg2 from '../../assets/images/destination (2).png'
import DestinationImg3 from '../../assets/images/destination (3).png'
import DestinationImg4 from '../../assets/images/destination (4).png'
import DestinationImg5 from '../../assets/images/destination (5).png'
import Footer from '../../Layout/Footer/Footer';

import CalenderImg from '../../assets/images/icons_calender.svg'
import { Link } from 'react-router-dom';

const FlexibleDateSelected = () => {
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <label className='destination-label' for="destinationimg1">
                                            <img src={DestinationImg1} className="destination-image" />
                                    ...
                                    <li>
                                        ...
                                        <label className='destination-label' for="destinationimg2">
                                            <img src={DestinationImg2} className="destination-image" />
                                            <div className="overlay"></div>
                                            <div className="destination-name">
                                                <p>Riyadh</p>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <label className='destination-label' for="destinationimg3">
                                            <img src={DestinationImg3} className="destination-image" />
                                            <div className="overlay"></div>
                                            <div className="destination-name">
                                                <p>Jeddah</p>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <label className='destination-label' for="destinationimg4">
                                            <img src={DestinationImg4} className="destination-image" />
                                            <div className="overlay"></div>
                                            <div className="destination-name">
                                                <p>Tabuk</p>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <label className='destination-label' for="destinationimg5">
                                            <img src={DestinationImg5} className="destination-image" />
                                            <div className="overlay"></div>
                                            <div className="destination-name">
                                                <p>Abha</p>
                                            </div>
                                            ...
                                            <div className="daatShowSelected">
                                                ...
                                                <div className="selectedDataWrapperFlexible">
                                                    <div className="img-txt d-flex align-items-center">
                                                        ...
                                                        <p className='selectedDataShowFlexible'>{`${Data.Week}, ${Data.month}, ${Data.year}`}</p>
                                                    </div>
...
export default FlexibleDateSelected
