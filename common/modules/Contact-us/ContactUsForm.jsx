...
import { submitContactForm } from '@/pages/api';
    ...
    return (
        <form className='contact-form-data' onSubmit={handleSubmit}>
            <div className="input-group-contact">
                ...
                <input type="text" className='inputArea' id='name' placeholder='Enter your name' onChange={handleChange} />
                <span className='error-msg'>{errName}</span>
            </div>
            <div className="input-group-contact">
                <label for="email"><Trans i18nKey="common.email"></Trans></label>
                <input type="email" className='inputArea' id='email' placeholder='Enter your email id' onChange={handleChange} />
            ...
            <div className="input-group-contact">
                ...
                <textarea className='inputArea textareamessage' rows="4" cols="6" placeholder='Include a message...' id='message' onChange={handleChange}></textarea>
