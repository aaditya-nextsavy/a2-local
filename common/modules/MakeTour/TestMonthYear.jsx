...
function TestMonthYear(props) {
    ...
    const handleSubmit = (event) => {
        ...
        // console.log("selectedDateFlexible",selectedDateFlexible)
    ...
    const handleWeeksChange = (event) => {
        event.preventDefault();
        // console.log(weeks, event.target.value )
    ...
    return (
        <form>
            ...
            <div className="MakeTourCalenderBtns submitBtnForm d-flex align-items-center">
                ...
                {showWeeks === true ? <button className="SecondaryButton" type="submit" onClick={handleSubmit} disabled={!weeks}><Trans i18nKey="common.selectweeks"></Trans></button> : <button className="SecondaryButton" onClick={handleNextClick} disabled={!selectedMonth || !selectedYear}><Trans i18nKey="common.selectMonth"></Trans></button>}
