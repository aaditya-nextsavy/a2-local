...
export default class BannerBigHorizontalLitePurple extends Component {
    render() {
        return (
            <>
                <div className="container">
                    <div className="backgroundcolor-wrapper lite-purple-color d-flex align-items-center">
                        ...
                        <div className="banner-img-wrapper">
                            <img src='/assets/images/192A9391.png' alt='banner-img.png' />
                        </div>
                    </div>
                </div>
            </>
